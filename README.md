<p align="center">
  <img src="design-system/brand/mongroo-app-icon.png" width="84" alt="몽그루 앱 아이콘">
</p>
...
<p align="center">
  <img src="docs/screenshots/web/readme-current/mood-to-growth.gif" width="320" alt="일기를 적어 저장하면 화분이 반응하고 홈에서 캐릭터가 자란 모습으로 이어지는 화면">
</p>
...
<table>
  <tr>
    <td width="50%"><img src="docs/screenshots/web/readme-current/diary-write.webp" alt="감정을 고르지 않고 오늘 있었던 일만 적는 일기 작성 화면"></td>
    <td width="50%"><img src="docs/screenshots/web/readme-current/home-mobile.webp" alt="오늘 적은 마음과 함께 자란 캐릭터가 보이는 홈 화면"></td>
  </tr>
  <tr>
...
![오늘 적은 마음과 캐릭터의 성장 단계, 이어서 할 작은 행동을 함께 보여 주는 홈 화면](docs/screenshots/web/readme-current/home.webp)
...
![같은 씨앗이 여섯 갈래로 갈라져 다섯 단계까지 자라는 성장 계보](design-system/character-lineage-previews/baby-pot-growth-preview.webp)
...
![10종 캐릭터가 감정별로 갈라져 자라는 성장 계보 모음](design-system/character-lineage-previews/all-character-lineages-overview.webp)
...
<table>
  <tr>
    <td width="42%"><img src="docs/screenshots/web/readme-current/calendar.webp" alt="기록을 남긴 날과 그날의 마음이 표시된 기록 달력 화면"></td>
    <td valign="top">
      <h3>날짜별로 다시 읽는 기록</h3>
...
![자주 읽힌 마음과 되돌아볼 질문, 기간 기록표를 정리한 월간 회고 화면](docs/screenshots/web/readme-current/report.webp)
...
![만개까지 키운 캐릭터들을 전시한 마음 식물 박물관 화면](docs/screenshots/web/readme-current/museum.webp)
...
![소품과 동행 친구를 배치한 나만의 방 화면](docs/screenshots/web/readme-current/room.webp)

<table>
  <tr>
    <td width="42%"><img src="docs/screenshots/web/readme-current/shop.webp" alt="씨앗으로 방 테마와 소품, 성장 계보를 해금하는 상점 화면"></td>
    <td valign="top">
      <h3>씨앗으로 넓히는 선택지</h3>
...
<table>
  <tr>
    <td width="42%"><img src="docs/screenshots/web/readme-current/adventure-hub.webp" alt="오늘의 성장 효율에서 마음 일기가 가장 큰 보상임을 보여 주는 탐험 화면"></td>
    <td valign="top">
...
되는 곁방에는 기록함과 떨어진 조각이 놓여 있습니다. 던전과 전투는 도트 한 칸의
크기가 화면 전체에서 같은 16비트 도트 화면으로 그렸습니다. 필드에 선 엉킴이
전투에서 만나는 그 엉킴이고, 걸음마다 발밑에 먼지가 일고, 전투로 들어갈 때는
양옆에서 도트 띠가 닫힙니다.

<p align="center">
  <img src="docs/screenshots/web/readme-current/dungeon-walk.gif" width="440" alt="캐릭터를 한 칸씩 움직여 서고 사이 흙길을 걸어 다니는 던전 화면">
</p>
...
<p align="center">
  <img src="docs/screenshots/mobile/20-integrated-battle.webp" width="330" alt="적의 다음 행동 예고와 고를 수 있는 행동 카드가 한 화면에 있는 전투 화면">
</p>
...
<table>
  <tr>
    <td width="42%"><img src="docs/screenshots/web/readme-current/trial.webp" alt="회원가입 없이 기기 안에서만 진행하는 3분 체험 시작 화면"></td>
    <td valign="top">
      <h3>기기 안에서만 도는 체험</h3>
      <ul>
...
| 캐릭터 | 18종 성장 계보, 여섯 갈래 감정 성장, 다섯 단계, 캐릭터별 고유 기술, 의상 교체 |
