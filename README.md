...
<p align="center">
  <img src="docs/screenshots/web/readme-current/home-current.webp" width="100%" alt="마음 기록과 함께 자라는 새싹몬이 보이는 몽그루 실제 홈 화면">
</p>

<p align="center"><sub>현재 릴리스 빌드의 실제 화면입니다. 마음을 적고, 돌보고, 함께 살아가는 과정을 담았습니다.</sub></p>
...
<table>
  <tr>
    <td width="33%"><img src="docs/screenshots/mobile/02-mood-record.webp" alt="오늘 있었던 일을 적는 마음 일기 화면"></td>
    <td width="33%"><img src="docs/screenshots/mobile/01-home.webp" alt="일기와 함께 자라는 캐릭터 홈 화면"></td>
    <td width="33%"><img src="docs/screenshots/mobile/04-plant-museum.webp" alt="성장을 마친 캐릭터를 다시 보는 박물관 화면"></td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td width="50%"><img src="docs/screenshots/web/03-calendar-wide.webp" alt="날짜별 마음을 살펴보는 기록 달력"></td>
    <td width="50%"><img src="docs/screenshots/web/07-reports-wide.webp" alt="한 주의 마음 흐름을 정리한 리포트"></td>
  </tr>
  <tr>
...
![여우비 캐릭터의 감정별 성장 도감 실제 화면](docs/screenshots/web/08-character-growth-atlas-wide.webp)
...
![10종 캐릭터의 감정별 성장 경로](design-system/character-lineage-previews/all-character-lineages-overview.webp)
...
<table>
  <tr>
    <td width="33%"><img src="app/assets/characters/restorer-pot-v7.webp" alt="블루그레이 복원 워크웨어를 입은 황혼 복원사 에단"></td>
    <td width="33%"><img src="app/assets/characters/marten-pot-v7.webp" alt="잎길 탐험 하네스를 착용한 잎귀 담비 모루"></td>
    <td width="33%"><img src="app/assets/characters/gal-pot-v7.webp" alt="코랄 워크 스트리트 복장을 입은 스타일 메이커 리아"></td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td width="38%"><img src="docs/screenshots/mobile/07-trial-welcome.webp" alt="회원가입 없이 시작하는 몽그루 3분 체험 화면"></td>
    <td valign="top">
...
<table>
  <tr>
    <td width="33%"><img src="docs/screenshots/mobile/03-daily-quest.webp" alt="오늘의 작은 실천을 제안하는 일일 미션"></td>
    <td width="33%"><img src="docs/screenshots/mobile/05-shop.webp" alt="씨앗으로 성장 계보와 아이템을 해금하는 상점"></td>
    <td width="33%"><img src="docs/screenshots/mobile/06-my-room.webp" alt="캐릭터와 소품을 배치한 나만의 방"></td>
  </tr>
  <tr>
...
그 지역의 스테이지 지도가 열리고, 전투·사건·쉼터·수호전이 여덟 걸음으로
이어집니다.

### 지도 위를 직접 걸어요

목적지를 목록에서 고르는 대신, 키운 캐릭터를 **타일로 이어진 던전 안에서 직접
움직입니다.** 화면 아무 곳이나 누르면 그 자리에 가상 스틱이 생기고, 손가락을
미는 쪽으로 걸어갑니다. 이동할 때마다 미니맵과 카메라가 함께 따라오고, 물가와
벽처럼 갈 수 없는 곳에서는 자연스럽게 멈춥니다.

![가상 스틱으로 이끼 기억서고의 타일 던전을 직접 걷는 실제 릴리스 플레이](docs/screenshots/web/readme-current/expedition-tile-world-walk.gif)

던전은 한 장의 큰 배경 그림이 아니라 바닥·이끼·물가·벽·등불 같은 타일과
조형물로 구성됩니다. 화면에는 지금 필요한 주변 구역만 이어서 보여 주기 때문에
큰 지도를 한꺼번에 올리지 않고도 부드럽게 이동할 수 있습니다. 미니맵에서는
현재 위치와 전체 길의 관계를 놓치지 않으며, 랜드마크 앞에 서면 그곳으로 들어갈지
물어봅니다.

![물가, 석조 바닥, 등불, 미니맵이 함께 보이는 이끼 기억서고 실제 플레이 화면](docs/screenshots/web/readme-current/expedition-tile-world-current.webp)

<table>
  <tr>
    <td width="50%"><img src="docs/screenshots/mobile/32-expedition-map.webp" alt="마음나무 관측실 지도에서 입구에 서 있는 캐릭터"></td>
    <td width="50%"><img src="docs/screenshots/mobile/33-expedition-free-walk.webp" alt="가상 스틱을 밀어 나무 회랑을 따라 걸어간 캐릭터와 남은 발자국"></td>
  </tr>
  <tr>
    <td align="center"><strong>여기서 출발</strong><br><sub>지금 서 있는 자리와 갈 수 있는 곳이 보여요</sub></td>
    <td align="center"><strong>손가락 가는 대로</strong><br><sub>누른 자리에 스틱이 생기고 발자국이 남아요</sub></td>
  </tr>
</table>

### 네 지역, 네 개의 다른 땅

이끼 기억서고에서 시작해 메아리 우물정원, 별씨앗 보관고, 마음나무 관측실까지
네 곳이 순서대로 열립니다. 지역마다 지형과 빛, 밟는 소리와 배경음이 다르고,
한 지역의 마지막 이야기가 다음 지역으로 이어집니다.

<table>
  <tr>
    <td width="50%"><img src="docs/screenshots/web/11-region-moss-archive-wide.webp" alt="모랫길과 이끼 언덕이 이어진 이끼 기억서고 지형"></td>
    <td width="50%"><img src="docs/screenshots/web/12-region-echo-well-wide.webp" alt="달빛에 젖은 돌길이 마름모로 얽힌 메아리 우물정원 지형"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="docs/screenshots/web/13-region-starlight-vault-wide.webp" alt="창백한 돌바닥과 씨앗 서랍장이 늘어선 별씨앗 보관고 지형"></td>
    <td width="50%"><img src="docs/screenshots/web/10-expedition-walk-heartwood-wide.webp" alt="나무 회랑이 층층이 감긴 마음나무 관측실 지형"></td>
  </tr>
  <tr>
    <td align="center"><strong>별씨앗 보관고</strong><br><sub>이름표를 잃은 씨앗들이 잠들지 못한 곳</sub></td>
...
한 번에 여러 스테이지를 몰아서 하지 않아도 됩니다. 허브는 다음에 갈 곳 하나만
크게 보여 주고, 떠나기 전에 누굴 만나는지와 걸리는 시간을 먼저 알려 줍니다.
...
### 스킬은 자라고, 전투 방식은 기록서로 달라져요

고유 기술은 캐릭터의 서사에 묶여 있어 다른 캐릭터에게 갈아 끼울 수 없습니다.
대신 **마음결 기록서**를 두 칸에 펼쳐 같은 캐릭터도 탐험 목적에 맞게 운용할 수
있습니다. 한 번 얻은 기록서는 사라지거나 소모되지 않고, `탐험`·`수호`·`나만의`
프리셋에 따로 정리됩니다.

<table>
  <tr>
    <td width="42%"><img src="docs/screenshots/mobile/31-skill-book-library.webp" alt="여우비의 마음결 기록서 프리셋과 두 선택 칸, 서고가 보이는 실제 화면"></td>
    <td valign="top">
      <h3>두 칸이 열리면서 선택도 깊어져요</h3>
      <ul>
        <li>Lv9에 <strong>선택 I</strong>, Lv23에 <strong>선택 II</strong>가 열립니다.</li>
        <li>3등급 기록서는 두 번째 칸 전용이며, 강한 효과만큼 분명한 대가가 붙습니다.</li>
        <li>상점 기록서는 정해진 씨앗으로, 도전 기록서는 적힌 조건을 달성해 얻습니다.</li>
        <li>아직 없는 기록서도 숨기지 않고 획득처와 잠금 이유를 함께 보여 줍니다.</li>
      </ul>
    </td>
  </tr>
</table>

전투 기록서 20종이 서고에 정리되어 있으며, 실제 전투 판정이 준비된 기록서부터
장착할 수 있습니다. 출발하는 순간의 편성과 기록서 구성을 탐험에 함께 저장하기
때문에, 탐험 도중 다른 화면에서 장착을 바꿔도 이미 출발한 파티의 구성이 뒤섞이지
않습니다.
...
<table>
  <tr>
    <td width="33%"><img src="app/assets/adventure/tangles/tangle-tangled-ledger-idle-v1.webp" alt="게임에 등장하는 엉킨 장부 뭉치"></td>
    <td width="33%"><img src="app/assets/adventure/tangles/tangle-drifting-pressings-idle-v1.webp" alt="게임에 등장하는 표류 압화 떼"></td>
    <td width="33%"><img src="app/assets/adventure/tangles/tangle-shelf-snarl-idle-v1.webp" alt="게임에 등장하는 큰 엉킴 서가 뒤엉킴"></td>
  </tr>
  <tr>
    <td align="center"><strong>엉킨 장부 뭉치</strong><br><sub>앞 대원과 전원을 번갈아 압박해 방어의 기본을 알려 줘요</sub></td>
    <td align="center"><strong>표류 압화 떼</strong><br><sub>가장 지친 대원을 노려 회복과 행동 순서를 시험해요</sub></td>
    <td align="center"><strong>서가 뒤엉킴</strong><br><sub>두꺼운 장벽과 전체 공격을 지닌 첫 큰 엉킴이에요</sub></td>
  </tr>
</table>

후반으로 갈수록 장벽만 두꺼워지는 대신 예고의 깊이, 약점 확인, 방어 여부에 따른
추가 기믹이 차례로 늘어납니다. 마지막 돌비늘 장부지기는 세 단계의 장벽을 넘을
때마다 약점·내성·공격 순서를 바꾸므로, 앞에서 익힌 상성과 기록서 조합을 모두
사용하게 됩니다.
...
| 캐릭터 | 15종 성장 계보, 감정별 성장, 캐릭터별 고유 기술 30종, 전투 기록서 20종, 표정·부분 모션, 의상 교체 |
| 생활 콘텐츠 | 일일 미션, 씨앗 재화, 상점, 방·정원 꾸미기, 박물관 |
| 모험 | 네 지역 각 8스테이지(전투·사건·쉼터·수호전), 타일 던전 직접 이동·미니맵·지형 충돌, 주변 구역을 이어 보여 주는 청크 렌더링, 1~3명 편성, 카드 한 장으로 즉시 행동하는 전투, 엉킴 3종과 3단계 보스, 자동 지휘·배속 |
