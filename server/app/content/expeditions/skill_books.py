...
SKILL_BOOK_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "first_breath": _book(
        ...
        effect_summary="전투 시작 시 기력 +1 (상한 5 유지)",
    ...
    "bracing": _book(
        ...
        grade=1,
        activation_mode="trigger",
        effect_summary="전투 1회, 방어를 고르면 기력 1 추가 생성",
    ...
    "final_resolve": _book(
        ...
        grade=1,
        activation_mode="trigger",
        effect_summary="적 장벽 20% 이하일 때 공격 위력 +5",
        stack_group="basic_power",
        acquire_kind="shop",
        price_seeds=40,
    ),
    ...
    "resonance_tuner": _book(
        ...
        grade=2,
        activation_mode="command",
        effect_summary="전투 1회, 자신의 다음 공격 성장 타입을 확정 전에 고른 다른 결로 변경",
    ...
    "focus_knot": _book(
        ...
        grade=2,
        activation_mode="trigger",
        effect_summary="전투 1회, 스킬 사용 후 기력 1 환급",
    ...
    "germination_gear": _book(
        ...
        grade=3,
        activation_mode="opening",
        effect_summary="전투 시작 기력 +2 (상한 5 유지)",
        stack_group="focus_start",
        acquire_kind="challenge",
...
# 성장 타입 기본 스킬과 현장 기록서라 어떤 계정에서도 여섯 슬롯이 비지 않는다.
