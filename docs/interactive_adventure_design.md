...
> **2026-08-08 구조 개편 공지** — 기본 진행 구조와 전투·화면 문법은
> `docs/expedition_stage_redesign.md`(stage-battle-v2.0)가 우선한다. 이 문서의
...
| 수호전 | 3인 전원의 `공격·고유 스킬·방어`와 순서를 매 라운드 직접 지휘. 자동 지휘는 선택 기능 |
